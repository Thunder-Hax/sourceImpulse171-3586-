...
//{
//	HUD::SetTextFont(0);
//	HUD::SetTextScale(0.4f, 0.4f);
//	HUD::SetTextColour(255, 255, 255, 255);
//	HUD::SetTextWrap(0.0f, 1.0f);
//	HUD::SetTextCentre(0);
//	HUD::SetTextDropShadow(1, 0, 0, 0, 0);
//	HUD::SetTextEdge(1, 0, 0, 0, 0);
//	HUD::SetTextOutline();
//}
...
void Renderer::NotifyMap(String text, boolean showInLog) {
	...
	HUD::AddTextComponentSubstringPlayerName(text);
	HUD::_SetNotificationMessage2("Bookmarks", "notify_generic", false, 0, "Thunder", "");
