...
void MoneyMenu::Init() {
	...
	//addOption(ToggleOption("To Bank").addToggle(vars.addToBank).addHotkey().canBeSaved().addRequirement([] { return GetAuth()->IsTester(); }).addTranslation().addTooltip("Should Thunder add this money to your bank or cash?"));
