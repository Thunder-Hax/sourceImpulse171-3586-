...
void LoadHandlingDataMenu::Init() {
	...
	addHandlingOption = addOption(ButtonOption("~c~Add handling data to ./Documents/Thunder/Handling")
		.addTooltip("Add handling data to ./Documents/Thunder/Handling").addTranslation());
}
