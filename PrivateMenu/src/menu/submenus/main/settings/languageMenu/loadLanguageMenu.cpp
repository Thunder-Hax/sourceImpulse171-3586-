...
void LoadLanguageMenu::Init() {
	...
	m_addLanguagesButton = addOption(ButtonOption("~c~Add languages to ./Documents/Thunder/Languages")
		.addTooltip("Add languages to ./Documents/Thunder/Languages").addTranslation());
}
