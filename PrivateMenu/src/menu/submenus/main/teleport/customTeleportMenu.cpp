...
void CustomTeleportMenu::Init() {
	...
	addTeleportsOption = addOption(ButtonOption("~c~Add teleports to ./Documents/Thunder/Teleports")
		.addTooltip("Add teleports to ./Documents/Thunder/Teleports").addTranslation());
