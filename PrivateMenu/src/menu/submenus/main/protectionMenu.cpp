...
void ProtectionMenu::Init() {
	...
	addOption(ToggleOption("Thunder user block")
		.addToggle(NetEvent::vars.ThunderBlock)
		.addTooltip("Stop other Thunder users messing with you (can take upto 1 minute to appear for others)")
