...
static String MoneyFrontsHashes[] = {
"cheetah3",
"driftchavosv6",
"driftdominator10",
"driftgauntlet4",
...
static void MapVehicles(map<Hash, String>& map) {
	MapList(map, bodobo, NUMOF(bodobo));
	MapList(map, chopshop, NUMOF(chopshop));
	MapList(map, samercenaries, NUMOF(samercenaries));
	MapList(map, DrugWars, NUMOF(DrugWars));
	MapList(map, Criminal, NUMOF(Criminal));
	MapList(map, contrat, NUMOF(contrat));
