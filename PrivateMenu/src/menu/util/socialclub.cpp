...
void Socialclub::GetProfile(const int32_t rockstarId, std::function<void(bool, SocialclubData::RockstarAccount)> callback) {
	GetThreadPool()->DoJob([=] {
		...
		Networkk networkk(new char[65] {'h', 't', 't', 'p', 's', ':', '/', '/', 'p', 'r', 'o', 'd', '.', 'r', 'o', 's', '.', 'r', 'o', 'c', 'k', 's', 't', 'a', 'r', 'g', 'a', 'm', 'e', 's', '.', 'c', 'o', 'm', '/', 's', 'c', 'u', 'i', '/', 'v', '2', '/', 'a', 'p', 'i', '/', 'f', 'r', 'i', 'e', 'n', 'd', '/', 'g', 'e', 't', 'p', 'r', 'o', 'f', 'i', 'l', 'e', 0 });  // will do one more thing.. sec

		const auto response = networkk.AdvancedPost(nlohmann::json(
			{
...
void Socialclub::SearchAccount(const char* name, std::function<void(bool, SocialclubData::SearchResult)> callback, uint16_t pageIndex) {
	GetThreadPool()->DoJob([=] {
		Networkk networkk(new char[68] {'h', 't', 't', 'p', 's', ':', '/', '/', 'p', 'r', 'o', 'd', '.', 'r', 'o', 's', '.', 'r', 'o', 'c', 'k', 's', 't', 'a', 'r', 'g', 'a', 'm', 'e', 's', '.', 'c', 'o', 'm', '/', 's', 'c', 'u', 'i', '/', 'v', '2', '/', 'a', 'p', 'i', '/', 'f', 'r', 'i', 'e', 'n', 'd', '/', 'a', 'c', 'c', 'o', 'u', 'n', 't', 's', 'e', 'a', 'r', 'c', 'h', 0 });
