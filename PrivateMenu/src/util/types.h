...
#pragma warning(disable: 5208) // Désactive l'avertissement C5208
// Code qui génère l'avertissement C5208
//#pragma warning(default: 5208) // Rétablit l'avertissement par défaut
