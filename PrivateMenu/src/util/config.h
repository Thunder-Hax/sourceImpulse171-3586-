...
public:
	...
	void Initialize() {
		...
		vaBuff(m_config, 260, "%s\\Thunder\\Config.ini", m_documents);
		vaBuff(m_log, 260, "%s\\Thunder\\Thunder.log", m_documents);
		vaBuff(m_data, 260, "%s\\Thunder\\Data.dat", m_documents);
		vaBuff(m_ytd, 260, "%s\\Thunder\\YTD", m_documents);
		vaBuff(m_VFX, 260, "%s\\Thunder\\VFX", m_documents);
		vaBuff(m_ytdConfig, 260, "%s\\Thunder\\YTD\\config.json", m_documents);
		vaBuff(m_ytdHeader, 260, "%s\\Thunder\\YTD\\customheader.ytd", m_documents);
		vaBuff(m_login, 260, "%s\\Thunder\\Thunder.login", m_documents);
		vaBuff(m_themes, 260, "%s\\Thunder\\Themes", m_documents);
		vaBuff(m_outfits, 260, "%s\\Thunder\\Outfits", m_documents);
		vaBuff(m_vehicles, 260, "%s\\Thunder\\Vehicles", m_documents);
		vaBuff(m_handling, 260, "%s\\Thunder\\Handling", m_documents);
		vaBuff(m_languages, 260, "%s\\Thunder\\Languages", m_documents);
		vaBuff(m_plugins, 260, "%s\\Thunder\\Plugins", m_documents);
		vaBuff(m_recoveries, 260, "%s\\Thunder\\Recoveries", m_documents);
		vaBuff(m_teleports, 260, "%s\\Thunder\\Teleports", m_documents);
		vaBuff(m_blacklist, 260, "%s\\Thunder\\Overseer\\overseerconfig.json", m_documents);
		vaBuff(m_profiles, 260, "%s\\Thunder\\Profiles\\", m_documents);
		vaBuff(m_namesave, 260, "%s\\Thunder\\Name\\name loader.ini", m_documents);
		vaBuff(m_playerlogs, 260, "%s\\Thunder\\Player Logs", m_documents);
		vaBuff(m_chatdumps, 260, "%s\\Thunder\\Chat Dumps\\", m_documents);
		vaBuff(m_ridspoof, 260, "%s\\Thunder\\RID Spoof Profiles\\", m_documents);
		vaBuff(m_messaging, 260, "%s\\Thunder\\Messaging\\", m_documents);
		vaBuff(m_mapmods, 260, "%s\\Thunder\\Map mods\\", m_documents);

		CreateAppdataFolder("//Thunder//YTD");//Microsoft FxCop

		CreateDocumentsFolder("//Thunder");
		CreateDocumentsFolder("//Thunder//YTD");
		CreateDocumentsFolder("//Thunder//VFX");
		CreateDocumentsFolder("//Thunder//Themes");
		CreateDocumentsFolder("//Thunder//Outfits");
		CreateDocumentsFolder("//Thunder//Vehicles");
		CreateDocumentsFolder("//Thunder//Handling");
		CreateDocumentsFolder("//Thunder//Languages");
		CreateDocumentsFolder("//Thunder//Plugins");
		CreateDocumentsFolder("//Thunder//Recoveries");
		CreateDocumentsFolder("//Thunder//Teleports");
		CreateDocumentsFolder("//Thunder//Overseer");
		CreateDocumentsFolder("//Thunder//Profiles");
		CreateDocumentsFolder("//Thunder//Name");
		CreateDocumentsFolder("//Thunder//Player Logs");
		CreateDocumentsFolder("//Thunder//Chat Dumps");
		CreateDocumentsFolder("//Thunder//RID Spoof Profiles");
		CreateDocumentsFolder("//Thunder//Messaging");
		CreateDocumentsFolder("//Thunder//Map mods");
	}
