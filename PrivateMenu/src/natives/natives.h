...
namespace DECORATOR
{
	...
	inline bool DecorSetInt(Entity entity, char* propertyName, int value) { return _i<bool>(0x0CE3AA5E1CA19E10, entity, propertyName, value); }
...
namespace PHYSICS
{
	...
	inline Void ApplyImpulseToCloth(float posX, float posY, float posZ, float vecX, float vecY, float vecZ, float Thunder) { return _i<Void>(0xE37F721824571784, posX, posY, posZ, vecX, vecY, vecZ, Thunder); }
